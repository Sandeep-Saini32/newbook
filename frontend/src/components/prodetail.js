...
if(saveprodata){
             ...
             if(spro.statuscode===1){
                ...
                setsavepro(spro.alldata)
                setname(spro.alldata.productname)
                setfile(spro.alldata.productfile)
                setprice(spro.alldata.productprice)
                setdetail(spro.alldata.productdetail)
                setproid(spro.alldata._id)
             }
 else{
    // alert("product data not fetched")
 }
...
return;
    ...
    const cartdata={name,price,file,qnt,userid}

    


const cartresult=await fetch("http://localhost:9000/api/cartinfo",{
...
return;
    ...
    const wishlist= await fetch("http://localhost:9000/api/wishlist",{
method:"POST",
...
if(wishlist.ok){
    ...
    const wh= await wishlist.json()
if(wh.statuscode===1){
    // alert("added to wishlist")
}
else{
    // alert("note added to wishliat")
}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="tf-product-info-wrap">
                        ...
                        <div class="tf-product-info-heading">
                            ...
                            <div class="product-info-price">
                                <div class="price-wrap">
                                    <span class="price-new price-on-sale h2">${Number(price).toLocaleString("en-Us")}</span>
                        ...
                        <div class="tf-product-total-quantity w-100">
                            <div class="group-btn">
                                <div class="wg-quantity">
                                    <button class="btn-quantity btn-decrease" onClick={()=>setqty(qnt>1? qnt-1:1)}>
                                
                                        <i class="icon icon-minus"></i>
                                        
                                    </button>
                                    <input class="quantity-product" type="text" name="number" value={qnt} />
                                    <button class="btn-quantity btn-increase" onClick={()=>setqty(qnt+1)}>
                 ...
                 {/* <Link to={`/cart/?id=${userid}`}> */}
                 <button  class="tf-btn animate-btn btn-add-to-cart"  onClick={addcart}>
                                    ADD TO CART
                                    <i class="icon icon-shopping-cart-simple"></i>
                                </button>
                         {/* </Link>  */}
                                ...
                                {/* <a href="#compare"  class="d-none d-sm-flex hover-tooltip tooltip-top box-icon flex-sm-shrink-0">
                                    <span class="icon icon-compare"></span>
                                    <span class="tooltip">Compare</span>
                                </a> */}
                            </div>
