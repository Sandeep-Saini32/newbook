...
const getcatproduct=async()=>{
    ...
    const getcatprodata=await fetch("http://localhost:9000/api/cathomepro",{
meythod:"Get"
...
const getmuysteryproduct=async()=>{
    ...
    const getmuysteryprodata=await fetch("http://localhost:9000/api/muysterypro",{
meythod:"Get"
...
const getlatestproduct=async()=>{
    ...
    const getlatestprodata=await fetch("http://localhost:9000/api/latestpro",{
method:"Get"
...
const getbestsellerpro=async()=>{
    ...
    const getbestprodata=await fetch("http://localhost:9000/api/bestpro",{
meythod:"Get"
...
const getrandomprodata=await fetch("http://localhost:9000/api/randompro",{
method:"Get"
